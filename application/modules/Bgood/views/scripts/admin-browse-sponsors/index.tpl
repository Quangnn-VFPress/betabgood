<div id="global_content">
	...
	<div class="admin_search">
		<div class="clear">
			<div class="search">
				<form action="index.php/admin/bgood/browse-sponsors" method="get" class="global_form_box" id="filter_form">
					<div>
				...
				<tbody>
					...
					<tr>
                        ...
                        <td class="admin_table_options">
                        	<?php echo $student['sponsor_id'] ? 'Đã kích hoạt' : 'Chưa kích hoạt'; ?>
                        </td>
						<td class="admin_table_options">
                        	<?php if(!$student['sponsor_id']) { ?>

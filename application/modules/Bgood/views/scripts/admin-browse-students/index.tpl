<div id="global_content">
	...
	<div class="admin_search">
		<div class="clear">
			<div class="search">
				<form action="index.php/admin/bgood/browse-students" method="get" class="global_form_box" id="filter_form">
					<div>
				...
				<tbody>
					...
					<tr>
                        ...
                        <td class="admin_table_options">
                        	<?php echo $student['student_id'] ? 'Đã kích hoạt' : 'Chưa kích hoạt'; ?>
                        </td>
						<td class="admin_table_options">
                        	<?php if(!$student['student_id']) { ?>
                            <a href="index.php/admin/bgood/browse-students/promote?id=<?php echo $student['user_id'];?>" class="smoothbox">
                                Promote
                            </a>
                            <?php } ?>
						</td>

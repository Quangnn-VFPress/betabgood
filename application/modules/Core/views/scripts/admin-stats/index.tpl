...
<?php
  ...
  if( $settings->getSetting('user.support.links', 0) == 1 ) {
    echo 'More info: <a href="http://anonym.to/http://support.socialengine.com/questions/221/Admin-Panel-Stats-Site-wide-Statistics" target="_blank">See KB article</a>.';	
  } 
?>	

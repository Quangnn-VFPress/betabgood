...
if( $settings->getSetting('user.support.links', 0) == 1 ) {
	echo 'More info: <a href="http://anonym.to/http://support.socialengine.com/questions/210/Admin-Panel-Layout-Theme-Editor" target="_blank">See KB article</a>';	
} 
?>	
<br />	
  ...
  <div class="admin_theme_chooser">
    ...
    <div class="admin_theme_header_controls">
      ...
      <div>
        ...
        <!--
        <a class="admin help" href="http://anonym.to/http://support.socialengine.com/questions/128/Creating-Your-Own-Theme" target="_blank" style="margin-left: 10px; margin-right: 0px;"> </a>
        -->
      </div>
    </div>

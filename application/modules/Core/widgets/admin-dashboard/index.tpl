  ...
  <ul class="admin_home_dashboard_links">
    ...
    <li>
      <ul>
        ...
        <li>
          <a href="http://anonym.to/http://www.socialengine.com/customize/se4" class="links_getplugins">
            <?php echo $this->translate("Get More Plugins") ?>
          </a>
        </li>
        <li>
          <a href="http://anonym.to/http://www.socialengine.com/customize/se4/themes" class="links_getthemes">

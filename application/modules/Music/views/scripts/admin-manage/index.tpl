...
if( $settings->getSetting('user.support.links', 0) == 1 ) {
	echo 'More info on the Music Plugin: <a href="http://anonym.to/http://support.socialengine.com/questions/190/Admin-Panel-Plugins-Music" target="_blank">See KB article</a>.<br />';	
} 
?>	

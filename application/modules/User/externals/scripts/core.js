...
/* $Id: core.js 9910 2013-02-14 19:22:15Z john $ */
    ...
    elements.each(function(el) {
      ...
      var selector = new Element('div', {
        ...
        'html' : '\
                  ...
                  <ul>\n\
                    <li data-value="everyone" class="field-privacy-option-everyone"><span class="icon"></span><span class="text">Everyone</span></li>\n\
                    <li data-value="registered" class="field-privacy-option-registered"><span class="icon"></span><span class="text">All Members</span></li>\n\
                    <li data-value="friends" class="field-privacy-option-friends"><span class="icon"></span><span class="text">Friends</span></li>\n\
                    <li data-value="self" class="field-privacy-option-self"><span class="icon"></span><span class="text">Only Me</span></li>\n\
                  </ul>\n\

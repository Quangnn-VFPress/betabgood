...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
    <tr>
        <td width="117px"><a onclick="changeOrder('displayname', '<?php echo ($this->order=='displayname' && $this->order_direction=='ASC')?'DESC':'ASC';?>');" href="javascript:void(0);"><h3 style="font-size: 12px;padding: 5px;">Sinh viên</h3></a></td>
        <td width="80px"><a href="javascript:void(0);"><h3 style="font-size: 12px;padding: 5px;">Đã tài trợ</h3></a></td>
        <td><a onclick="changeOrder('user_id', '<?php echo ($this->order=='user_id' && $this->order_direction=='ASC')?'DESC':'ASC';?>');" href="javascript:void(0);"><h3 style="font-size: 12px;padding: 5px;">Hồ sơ mới</h3></a></td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <p>Học trường : <?php echo $user['university_name']!='' ? $user['university_name']:$user['highschool_name'];?></p>
            <p>Giới tính : <?php echo $user['gender']==1 ? 'Nam':'Nữ';?></p>

...
<p>
  ...
  <a class="admin help" href="http://anonym.to/http://support.socialengine.com/questions/188/How-to-use-the-CDN-Storage-Feature" target="_blank"> </a>
</p>
<br />
<?php
$settings = Engine_Api::_()->getApi('settings', 'core');
if( $settings->getSetting('user.support.links', 0) == 1 ) {
	echo 'More info: <a href="http://anonym.to/http://support.socialengine.com/questions/224/Admin-Panel-Settings-Storage-System" target="_blank">See KB article</a>.';	
} 
?>	
<br />	
<br />
